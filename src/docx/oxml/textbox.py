...
from .xmlchemy import (BaseOxmlElement, OneAndOnlyOne, OneOrMore, RequiredAttribute, ZeroOrMore, ZeroOrOne, )
...
class TextBox(ElementProxy):
    ...
    def __init__(self, element):
        ...
        try:
            ...
            raise ValueError("This element is not a text box; it should contain precisely two \
